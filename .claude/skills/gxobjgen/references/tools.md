...
Todas chamáveis como `mcp__genexus__<nome>`. Lembre: são *deferred* — carregue o schema com
`ToolSearch query="select:mcp__genexus__<nome>[,...]"` antes de chamar. Com várias KBs abertas,
passe `kb=<slug>` (veja `gx_targets`).
